 ...
 * @Summary = Verify that user can't be able to login with invalid password.
 */
public class MaLoginWithWrongPassword {
    WebDriver driver;
    ...
    public void loginWithInvalidPassword() throws InterruptedException {
        ...
        driver.findElement(By.id("passwd")).sendKeys("dajsidsajkda");
